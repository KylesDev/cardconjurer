if (!loadedVersions.includes('m15Promo/nickname')) {
	...
	loadFrameImages([
		...
		['Artifact (Alt) Nickname Title', '/data/images/cardImages/m15/m15NicknameTitleAAlt.png', 74/1500, 85/2100, 1352/1500, 221/2100, ['Full', 'Nickname Title (m15)', 'Title (m15)', 'Nickname True Name (m15)']],
		...
		['Artifact (Alt) Nickname Legend Crown', '/data/images/cardImages/m15/m15NicknameCrownAAlt.png', 36/1500, 36/2100, 1428/1500, 270/2100, ['Full', 'Nickname Legend Crown (m15)', 'Title (m15)', 'Nickname True Name (m15)']],
