...
var masks = [{src:'/img/frames/storybook/borderless/TitleMask.png', name:'Title'}, {src:'/img/frames/storybook/borderless/TypeMask.png', name:'Type'}, {src:'/img/frames/storybook/borderless/RulesMask.png', name:'Rules'}, {src:'/img/frames/storybook/borderless/FrameMask.png', name:'Frame'}, {src:'/img/frames/m15/regular/m15MaskBorder.png', name:'Border'}];
//Create objects for common properties across available frames
