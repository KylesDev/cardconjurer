...
var masks = [{src:'/img/frames/iko/short/pinline.svg', name:'Pinline'}, {src:'/img/frames/custom/kyles/masks/pinline_lower.svg', name:'Pinline (Lower)'},{src:'/img/frames/m15/regular/m15MaskTitle.png', name:'Title'}, {src:'/img/frames/iko/short/type.svg', name:'Type'}, {src:'/img/frames/iko/short/rules.svg', name:'Rules'}, {src:'/img/frames/m15/regular/m15MaskBorder.png', name:'Border'}];
